...
if (!function_exists('feature_coin_cost')) {
    function feature_coin_cost($feature, $default = 1)
    {
        ...
        return max(0, (int) get_setting($settingKey, $default));
    }
}
...
if (!function_exists('get_max_date_female')) {
    function get_max_date_female()
    {   
        $min_age = get_setting('female_min_age') != null ? get_setting('female_min_age') : 0;
        $current_date = Carbon::now();
        $max_date = $current_date->subYears($min_age);
        
        return date("Y-m-d", strtotime($max_date));
    }
}

if (!function_exists('get_max_date_male')) {
    function get_max_date_male()
    {

        $min_age = get_setting('male_min_age') != null ? get_setting('male_min_age') : 0;
        $current_date = Carbon::now();
        $max_date = $current_date->subYears($min_age);
