...
class PaymentTypesController extends Controller
{
    public function getList(Request $request)
    {
        ...
        if (get_setting('easypaisa_payment_activation') == 1) {
            $payment_type = array();
            $payment_type['payment_type'] = 'easypaisa_payment';
            $payment_type['payment_type_key'] = 'easypaisa';
            $payment_type['image'] = '';
            $payment_type['name'] = 'EasyPaisa';
            $payment_type['title'] = translate('Checkout with EasyPaisa');
            $payment_type['offline_payment_id'] = 0;
            $payment_type['details'] = get_setting('EASYPAISA_PAYMENT_INSTRUCTIONS') ?: '';
