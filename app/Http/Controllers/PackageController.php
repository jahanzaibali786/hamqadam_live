...
class PackageController extends Controller
{
    public function __construct()
    {
        ...
        $this->package_messages = [
            ...
            'express_interest.required'  => translate('No. of package coins is required'),
    ...
    public function store(Request $request)
    {
        ...
        if ($request->auto_horoscope_profile_match != null) {
            $package->auto_horoscope_profile_match = 1;
        } else {
            $package->auto_horoscope_profile_match = 0;
        }
    ...
    public function select_package()
    {
        ...
        return view('frontend.package.packages', compact('packages', 'user'));
    }
