...
class ChatController extends Controller
{
    ...
    public function chat_view($id)
    {
        ...
        return view('frontend.member.messages.messages', compact('chats', 'chat_thread', 'chat_partner', 'chat_is_blocked', 'chat_blocked_by_me', 'chat_blocked_by_other', 'chat_blocker_name', 'can_send_message', 'user_to_show'));
    }
