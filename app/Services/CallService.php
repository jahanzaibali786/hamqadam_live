...
class CallService
{
    ...
    public function start(User $caller, int $threadId, string $callType): array
    {
        ...
        return [
            'call' => $this->payload($call->fresh(['caller', 'receiver', 'conversation']), $caller)['call'],
            'rtc' => $rtc,
        ];
    ...
    public function accept(User $user, int $callId): array
    {
        ...
        return [
            'call' => $this->payload($call->fresh(['caller', 'receiver', 'conversation']), $user, null, $rtc)['call'],
            'rtc' => $rtc,
        ];
    ...
    public function reject(User $user, int $callId): array
    {
        ...
        return [
            'call' => $this->payload($call->fresh(['caller', 'receiver', 'conversation']), $user, null)['call'],
        ];
    ...
    public function connect(User $user, int $callId): array
    {
        ...
        return [
            'call' => $this->payload($call->fresh(['caller', 'receiver', 'conversation']), $user)['call'],
        ];
