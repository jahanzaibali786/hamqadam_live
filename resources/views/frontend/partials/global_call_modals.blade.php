            ...
            <div class="modal-body p-0">
                <div class="global-call-screen bg-dark text-white position-relative overflow-hidden">
                    ...
                    <div class="global-call-controls d-flex justify-content-center align-items-center flex-wrap gap-2 px-3 pb-4">
                        <button type="button" class="btn btn-icon btn-circle btn-light" id="global-call-toggle-mic" onclick="event.preventDefault(); event.stopPropagation(); toggleCallMic(event); return false;"><i class="las la-microphone"></i></button>
                        <button type="button" class="btn btn-icon btn-circle btn-light d-none" id="global-call-toggle-camera" onclick="event.preventDefault(); event.stopPropagation(); toggleCallCamera(event); return false;"><i class="las la-video"></i></button>
