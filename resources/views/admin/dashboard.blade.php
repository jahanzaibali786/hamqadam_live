...
@endphp
    @can('admin_dashboard')
        ...
        <div class="alert alert-info d-flex align-items-center justify-content-between">
            <div>
                <strong>{{ translate('AI Platform APIs are enabled.') }}</strong>
                <span>{{ translate('Review verification, moderation, AI, payment, and API rollout status from the control center.') }}</span>
            </div>
            <a href="{{ route('admin.v1_platform') }}" class="btn btn-sm btn-primary">{{ translate('Open Control Center') }}</a>
        </div>
