...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{ translate('EasyPaisa Credential') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="easypaisa_payment_activation" type="checkbox"
                                        @if (get_setting('easypaisa_payment_activation') == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="EASYPAISA_STORE_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Store ID') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="EASYPAISA_STORE_ID"
                                    value="{{ get_setting('EASYPAISA_STORE_ID') ?? env('EASYPAISA_STORE_ID') }}"
                                    placeholder="{{ translate('EasyPaisa Store ID') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="EASYPAISA_ACCOUNT_MSISDN">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Account / MSISDN') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="EASYPAISA_ACCOUNT_MSISDN"
                                    value="{{ get_setting('EASYPAISA_ACCOUNT_MSISDN') ?? env('EASYPAISA_ACCOUNT_MSISDN') }}"
                                    placeholder="{{ translate('03xxxxxxxxx') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="EASYPAISA_USERNAME">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Username') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="EASYPAISA_USERNAME"
                                    value="{{ get_setting('EASYPAISA_USERNAME') ?? env('EASYPAISA_USERNAME') }}"
                                    placeholder="{{ translate('EasyPaisa Username') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="EASYPAISA_PASSWORD">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Password') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="password" class="form-control" name="EASYPAISA_PASSWORD"
                                    value="{{ get_setting('EASYPAISA_PASSWORD') ?? env('EASYPAISA_PASSWORD') }}"
                                    placeholder="{{ translate('EasyPaisa Password') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="EASYPAISA_HASH_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Hash Key') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="EASYPAISA_HASH_KEY"
                                    value="{{ get_setting('EASYPAISA_HASH_KEY') ?? env('EASYPAISA_HASH_KEY') }}"
                                    placeholder="{{ translate('EasyPaisa Hash Key') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="EASYPAISA_ENDPOINT">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('API Endpoint') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="EASYPAISA_ENDPOINT"
                                    value="{{ get_setting('EASYPAISA_ENDPOINT') ?? env('EASYPAISA_ENDPOINT') }}"
                                    placeholder="{{ translate('https://...') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="settings_types[]" value="EASYPAISA_PAYMENT_INSTRUCTIONS">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Payment Instructions') }}</label>
                            </div>
                            <div class="col-md-8">
                                <textarea class="form-control" name="EASYPAISA_PAYMENT_INSTRUCTIONS" rows="3"
                                    placeholder="{{ translate('Instructions shown to app users during checkout') }}">{{ get_setting('EASYPAISA_PAYMENT_INSTRUCTIONS') ?? env('EASYPAISA_PAYMENT_INSTRUCTIONS') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('EasyPaisa Sandbox Mode') }}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="easypaisa_sandbox" type="checkbox"
                                        @if (get_setting('easypaisa_sandbox') == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{ translate('JazzCash Credential') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="jazzcash_payment_activation" type="checkbox"
                                        @if (get_setting('jazzcash_payment_activation') == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="JAZZCASH_MERCHANT_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Merchant ID') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="JAZZCASH_MERCHANT_ID"
                                    value="{{ get_setting('JAZZCASH_MERCHANT_ID') ?? env('JAZZCASH_MERCHANT_ID') }}"
                                    placeholder="{{ translate('JazzCash Merchant ID') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="JAZZCASH_ACCOUNT_MSISDN">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Account / MSISDN') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="JAZZCASH_ACCOUNT_MSISDN"
                                    value="{{ get_setting('JAZZCASH_ACCOUNT_MSISDN') ?? env('JAZZCASH_ACCOUNT_MSISDN') }}"
                                    placeholder="{{ translate('03xxxxxxxxx') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="JAZZCASH_PASSWORD">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Password') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="password" class="form-control" name="JAZZCASH_PASSWORD"
                                    value="{{ get_setting('JAZZCASH_PASSWORD') ?? env('JAZZCASH_PASSWORD') }}"
                                    placeholder="{{ translate('JazzCash Password') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="JAZZCASH_INTEGRITY_SALT">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Integrity Salt') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="JAZZCASH_INTEGRITY_SALT"
                                    value="{{ get_setting('JAZZCASH_INTEGRITY_SALT') ?? env('JAZZCASH_INTEGRITY_SALT') }}"
                                    placeholder="{{ translate('JazzCash Integrity Salt') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="JAZZCASH_ENDPOINT">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('API Endpoint') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="JAZZCASH_ENDPOINT"
                                    value="{{ get_setting('JAZZCASH_ENDPOINT') ?? env('JAZZCASH_ENDPOINT') }}"
                                    placeholder="{{ translate('https://...') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="settings_types[]" value="JAZZCASH_PAYMENT_INSTRUCTIONS">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('Payment Instructions') }}</label>
                            </div>
                            <div class="col-md-8">
                                <textarea class="form-control" name="JAZZCASH_PAYMENT_INSTRUCTIONS" rows="3"
                                    placeholder="{{ translate('Instructions shown to app users during checkout') }}">{{ get_setting('JAZZCASH_PAYMENT_INSTRUCTIONS') ?? env('JAZZCASH_PAYMENT_INSTRUCTIONS') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('JazzCash Sandbox Mode') }}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="jazzcash_sandbox" type="checkbox"
                                        @if (get_setting('jazzcash_sandbox') == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
