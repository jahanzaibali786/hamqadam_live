...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{ translate('Male Member Minimum Age') }}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="male_min_age">
                                <input type="number" name="male_min_age" step="1" class="form-control"
                                    value="{{ get_setting('male_min_age') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{ translate('Female Member Minimum Age') }}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="female_min_age">
                                <input type="number" name="female_min_age" step="1" class="form-control"
                                    value="{{ get_setting('female_min_age') }}">
                            </div>
                        </div>
    ...
    echo 'checked';
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8">
                            <label class="col-from-label">{{ translate('Registration Verification') }}
                                <i>
                                    <code>({{ translate('You need to configure SMTP correctly to enable this feature.') }}
                                        <a
                                            href="{{ route('smtp_settings') }}">{{ translate('Configure Now') }}</a>)</code>
                        ...
                        <div class="col-sm-4">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="updateSettings(this, 'registration_verification')"
                                    <?php if (get_setting('registration_verification') == 1) {
                                        echo 'checked';
                                    } ?>>
                                <span class="slider round"></span>
                            </label>
