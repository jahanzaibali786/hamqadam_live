    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('admin.v1_platform') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.v1_platform']) }}">
                        <i class="las la-robot aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('AI Platform') }}</span>
                    </a>
                </li>

                <li class="aiz-side-nav-item">
                    <a href="{{ route('admin.v1_platform.matchmaking_settings') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.v1_platform.matchmaking_settings']) }}">
                        <i class="las la-sliders-h aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('AI Matchmaking Settings') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('MVP Operations') }}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.mvp.payments') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.mvp.payments']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Payment Approvals') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.mvp.relationship_statuses') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.mvp.relationship_statuses']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Relationship Statuses') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.mvp.proposal_meetings') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.mvp.proposal_meetings']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Proposal Meetings') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.mvp.expert_questions') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.mvp.expert_questions']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Expert Questions') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.mvp.community') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.mvp.community']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Community Moderation') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('admin.mvp.content') }}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.mvp.content']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Content Manager') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
