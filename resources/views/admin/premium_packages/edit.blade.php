            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{translate('Package Coins')}}</label>
                            <div class="col-md-9">
                                ...
                                @error('express_interest')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                                <small>{{ translate('Coins are used when a member sends an express interest or consumes coin-based features.') }}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{translate('Auto Horoscope Profile Matching Show')}}</label>
                            <div class="col-md-8 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="auto_horoscope_profile_match" @if ($package->auto_horoscope_profile_match == "1") checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
