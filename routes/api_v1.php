...
Route::middleware(['auth:sanctum', 'manual.review'])->get('/admin/overview', AdminOverviewController::class)->name('api.v1.admin.overview');
...
Route::prefix('auth')->name('api.v1.auth.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'manual.review'])->group(function () {
        ...
        Route::get('/manual-review/status', [AuthController::class, 'manualReviewStatus'])->name('manual_review.status');
        Route::post('/manual-review/contact', [AuthController::class, 'submitManualReviewContact'])->name('manual_review.contact');
...
Route::middleware(['auth:sanctum', 'manual.review'])->prefix('chat')->name('api.v1.chat.')->group(function () {
    ...
    Route::prefix('/calls')->name('calls.')->group(function () {
        Route::post('/', [CallController::class, 'start'])->middleware('throttle:30,1')->name('start');
        Route::get('/{call}', [CallController::class, 'show'])->whereNumber('call')->name('show');
        Route::post('/{call}/accept', [CallController::class, 'accept'])->whereNumber('call')->name('accept');
        Route::post('/{call}/reject', [CallController::class, 'reject'])->whereNumber('call')->name('reject');
        Route::post('/{call}/cancel', [CallController::class, 'cancel'])->whereNumber('call')->name('cancel');
...
Route::prefix('payments')->name('api.v1.payments.')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'manual.review'])->group(function () {
        ...
        Route::get('/checkout/{payment}/status', [PaymentController::class, 'checkoutStatus'])->whereNumber('payment')->name('checkout.status');
