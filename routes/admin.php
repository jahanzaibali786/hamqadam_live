...
use App\Http\Controllers\MvpAdminController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(MvpAdminController::class)->prefix('mvp')->name('admin.mvp.')->group(function () {
        Route::get('/payments', 'payments')->name('payments');
        Route::post('/payments/{payment}/reject', 'rejectPayment')->name('payments.reject');
        Route::get('/relationship-statuses', 'relationshipStatuses')->name('relationship_statuses');
        Route::post('/relationship-statuses/{status}', 'updateRelationshipStatus')->name('relationship_statuses.update');
        Route::get('/proposal-meetings', 'proposalMeetings')->name('proposal_meetings');
        Route::post('/proposal-meetings/{meeting}', 'updateProposalMeeting')->name('proposal_meetings.update');
        Route::get('/expert-questions', 'expertQuestions')->name('expert_questions');
        Route::post('/expert-questions/{question}', 'answerExpertQuestion')->name('expert_questions.answer');
        Route::get('/community', 'community')->name('community');
        Route::post('/community/threads/{thread}', 'updateThread')->name('community.threads.update');
        Route::post('/community/posts/{post}', 'updatePost')->name('community.posts.update');
        Route::get('/content', 'content')->name('content');
        Route::post('/content/forums', 'storeForum')->name('content.forums.store');
        Route::post('/content/webinars', 'storeWebinar')->name('content.webinars.store');
        Route::post('/content/marriage-tips', 'storeMarriageTip')->name('content.marriage_tips.store');
        Route::post('/content/regional-updates', 'storeRegionalUpdate')->name('content.regional_updates.store');
    });
    ...
    Route::controller(SettingController::class)->group(function () {
        ...
        Route::get('/coin-charge-settings', 'coin_charge_settings')->name('coin_charge_settings');
